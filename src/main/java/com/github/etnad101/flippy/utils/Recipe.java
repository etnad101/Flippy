...
public class Recipe {
    ...
    public float totalCost(ICommandSender sender, int craftAmount) {
        float totalCost = 0;
        ...
        for (int i = 0; i < ingredients.size(); i++) {
            ...
            float cost = prod.quick_status.sellPrice * amount * craftAmount;
            totalCost += cost;
            sender.addChatMessage(new ChatComponentText(name + ": " + amount * craftAmount + " -> §7$" + cost));
        }
